  ...
  <body class="text-center">
    ...
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlinsert = "INSERT INTO inventário (UserName, Senha) VALUES('$nome','$senha')";
        ...
        if ($conn->query($sqlinsert) === TRUE) {
          ...
          echo "Erro ao adicionar um novo usuário: " . $conn->error;
        }
      }
    ...
    <div class="container shadow p-3 mb-5 bg-white rounded card">
      <form action="" method="post">
        ...
        <div class="row shadow p-3 mb-5 bg-white rounded card p-4">
          <button class="btn btn-custom w-100" type="submit">Criar Conta</button>
        </div>
      </form>

      <div class="row">
        <p>Já possui uma conta? <a href="index.php" class="create-account-link">Faça login aqui</a></p>
      </div>
    </div>
